...
class Route {
    ...
    /**
     * @var  string namespace for current and and all further routes
     */
    ...
    public static function current_namespace($name = false) {
        if($name === false) {
            return static::$controller_namespace;
        } else {
            static::$controller_namespace = $name;
        }
    }
    ...
    public static function cache($save = FALSE, $append = FALSE)
    {
        if ($save === TRUE)
        {
            try
            {
                ...
                Cache::instance()->set('Route::cache()', Route::$_routes, 28800);
            }
            catch (Exception $e)
            {
    ...
    public function __construct($uri = NULL, $regex = NULL)
    {
        ...
        $this->_controller_ns = Route::current_namespace();
    }
    ...
    public function matches(Request $request)
    {
        ...
        if ( ! empty($params['controller']))
        {
            ...
            $params['controller'] = $this->_controller_ns.'\\'.ucfirst($params['controller']);
        }
