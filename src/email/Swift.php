...
class Swift {
    ...
    public static function mailer()
    {
        if ( ! Swift::$_mailer)
        {
            ...
            Swift::$_mailer = \Swift_Mailer::newInstance($transport);
        }

        return Swift::$_mailer;
    }
    ...
    {
        return new Swift($subject, $message, $type);
    }
    ...
    {
        return Swift::mailer()->send($this->_message, $failed);
    }
...
if( ! defined('SWIFT_INIT_LOADED')) {
    ...
    require MIIPATH.'../vendor/swiftmailer/swiftmailer/lib/swift_required.php';
