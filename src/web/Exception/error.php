...
<div id="kohana_error">
    <h1><span class="type"><?php echo $class ?> [ <?php echo $code ?> ]:</span> <span class="message"><?php echo \mii\util\HTML::chars($message) ?></span></h1>
                ...
                <li>
					...
					<span class="file">
						<?php if ($step['file']): $source_id = $error_id.'source'.$i; ?>
                            <a href="#<?php echo $source_id ?>" onclick="return koggle('<?php echo $source_id ?>')"><?php echo \mii\util\Debug::path($step['file']) ?> [ <?php echo $step['line'] ?> ]</a>
                        <?php else: ?>
                            ...
                            <table cellspacing="0">
                                <?php foreach ($step['args'] as $name => $arg): ?>
                                    <tr>
                                        ...
                                        <td><pre><?php echo \mii\util\Debug::dump($arg) ?></pre></td>
                                    </tr>
                                <?php endforeach ?>
                            </table>
                        </div>
                ...
                <table cellspacing="0">
                    <?php foreach ($GLOBALS[$var] as $key => $value): ?>
                        <tr>
                            ...
                            <td><pre><?php echo \mii\util\Debug::dump($value) ?></pre></td>
                        </tr>
                    <?php endforeach ?>
                </table>
            </div>
